...
def get_live_report(date: Optional[str] = None):
    ...
    for center in active_plans:
        ...
        center_stats.append({
            ...
            "quantity_filled_tons": c_booked_tons,
    ...
    return {
        "date": target_date,
        "tons_per_token_estimate": 0.5,
        "centers": center_stats,
        "totals": {
            "total_tokens": total_tokens,
            "total_filled_tons": total_procured_tons,
            "total_limit_tons": total_capacity_tons,
            "total_fill_percent": overall_utilization,
        },
    }
